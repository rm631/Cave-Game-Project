...
public class LevelController : MonoBehaviour {
	...
	// To avoid any script errors or confusion caused by this now currently disabled script, I have commented the whole thing out..
	...
	//public script mapGeneratorScript;
	
	int level = 1;
	
	//void Start() {
	//	scriptHolder = scriptHolder.GetComponent<MapGenerator>();
	//}
	...
	public int randomFillPercent = 50; // I set a default value for this, however it can be edited within the Inspector.
