...
namespace Consolation
{
	...
	class Console : MonoBehaviour
	{
		...
		void Update ()
		{
			if( toggleKey == KeyCode.BackQuote ) {
				if (Application.platform == RuntimePlatform.OSXEditor) {
					...
					Debug.Log( "Unity is running on OSX swithcing to 'Delete' as Console key." );
				}
			}

			if (Input.GetKeyDown(toggleKey)) {
				visible = !visible;
				//Debug.Log ( "Console is now Open." );
			}
		...
		{
			scrollPosition.y = 1000000; // Have scrollposition always at the bottom
